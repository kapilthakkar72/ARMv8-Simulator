...
//	String nextInstruction;
	...
	public static void main(String args[])
	{
		...
		try{
			...
			File f=new File("Ctest1");
			
			Elf elfObj=new Elf(f);		
			
			
			ElfHeader elfHeader=elfObj.getHeader();
			
			// Read text section
			Section textSection=elfObj.getSectionByName(".text");			
			String textInstructions= elfObj.getbinaryStringFromSection(textSection,0);
			
			// read data section
			Section dataSection=elfObj.getSectionByName(".data");			
			String dataSectionContents= elfObj.getbinaryStringFromSection(dataSection,0);
			...
			//armv8SimObj.dataStructureObj.register[31]=InstructionExecution.padLeftStatic(Long.toBinaryString(dataAddress), 64, '0').toCharArray();
