...
public class Elf
{
  ...
  public final String getbinaryStringFromSection( final Section section, final int index ) throws IOException
  {
	    if ( index > section.getSize() )
	    {
	      return "";
	   ...
	   // while ( true )
	    //{
	      ...
	      for ( int i = 0; i < len; i++ )
	      {
	        ...
	        //str.append( ( char )tmp[i] );
	        str.append(String.format("%02X", tmp[i]));
	      }
	      /*if ( len <= 0 )
	      {
	        break;
