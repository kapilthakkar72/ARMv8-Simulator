...
public class InstructionExecution {
	...
	public void addShiftRegister32bit(String s,String hexInstruction,FileWriter fw)
	{
		...
		// perform addition
		char carry='0';
		char result[]=padLeft("", 64, '0').toCharArray();
	...
	public void addImmediate32bit(String s,String hexInstruction,FileWriter fw)
	{
		...
		// perform addition
				...
				if(rd==31)
				{
					stackPointer=copy(d.register[rd]);
				}
		}
		catch(Exception ex)
		{
	...
	public void addExtendedRegister32bit(String s)
	{
		...
		String spInHex="";
		 ...
		 if(rm!=31)
		 {
			 operand2=ExtendReg(rm, extend_type,shift,datasize);
		 }
		 else
		 {
			 operand2=padLeft("", datasize, '0').toCharArray();
		 }
